...
#include "rakuda_control/rakuda_hardware.hpp"
#include "hardware_interface/types/hardware_interface_type_values.hpp"
#include "rclcpp/rclcpp.hpp"


namespace rakuda_control
{
static rclcpp::Logger LOGGER = rclcpp::get_logger("RakudaHardware");
...
CallbackReturn RakudaHardware::on_init(
...
RakudaHardware::export_state_interfaces()
{
...
RakudaHardware::export_command_interfaces()
{
...
CallbackReturn RakudaHardware::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn RakudaHardware::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
return_type RakudaHardware::read(
...
return_type RakudaHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (communication_timeout()) {
    if (!timeout_has_printed_) {
...
bool RakudaHardware::communication_timeout()
{
